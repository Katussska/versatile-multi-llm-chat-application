...
export class Migration20260421000000 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(`alter table "model" add column "price_per_token" float not null default 0;`);
    this.addSql(`alter table "message" add column "cost_usd" float not null default 0;`);
  }
